...
public:
	...
	void setSh_Vector_poz(sf::Vector2f f) { this->sprite_shadow.setPosition(f); }
	void setSh_Vector_poz(float fo,float f2) { this->sprite_shadow.setPosition(sf::Vector2f(fo, f2)); }
